...
extension LoginViewController: ViewCode {
    ...
    func setupConstrains() {
        NSLayoutConstraint.activate([
            ...
            self.logoImage.topAnchor.constraint(equalTo: self.view.safeAreaLayoutGuide.topAnchor,constant: 100),
            self.logoImage.heightAnchor.constraint(equalToConstant: 220),
            self.logoImage.widthAnchor.constraint(equalToConstant: 300),
            
            self.tfLogin.topAnchor.constraint(equalTo: self.logoImage.bottomAnchor, constant: 60),
