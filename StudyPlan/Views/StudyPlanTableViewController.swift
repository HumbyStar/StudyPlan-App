...
//  StudyPlan
//  self.navigationItem.title = UIDevice.current.orientation.isLandscape ? "Planos de Estudo" : "kanlsfknajflnadfjkladf"
...
final class StudyPlanTableViewController: UITableViewController {
    ...
    func prepareView() {
        ...
        var attributes: [NSAttributedString.Key : Any] = [NSAttributedString.Key.foregroundColor: UIColor.purple]
        if let font = UIFont(name: "Georgia", size: 30) {
...
extension StudyPlanTableViewController: MyModalDelegate {
